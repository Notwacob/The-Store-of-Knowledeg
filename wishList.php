...
<!-----Instructor: DR. Wang-------->
<!-----Due: May 1, 2023-------->
<!-----Goal: The sites wishlist page that will displays the wishlist information for the user that is currently loged in. ------>
...
if (isset($_POST['del'])) {
    ...
    $username = $_SESSION["username"];
    $del_q = "DELETE FROM wishList WHERE username='$username' AND edition_id='$olid_id'";
...
<head>
    ...
    <title>The Store of Knowledge - Wish List</title>
